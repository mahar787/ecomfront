...
const page = () => {
  ...
  const accountDetails = {
    accountNumber: "1234567890", // Replace with your account number
  ...
  const onSubmit = async (data) => {
    ...
    formData.append("paymentMode", "jazzcash");
          ...
          <div className="px-8 py-6 bg-gray-100">
            ...
            <p className="text-lg font-semibold text-gray-700">
              ...
              <span className="font-normal">
                {Array.isArray(additionals) &&
                  ...
                  additionals[0]?.accountNumberJazzCash}
              </span>
            </p>
            <p className="mt-2 text-lg font-semibold text-gray-700">
              ...
              <span className="font-normal">
                {Array.isArray(additionals) &&
                  additionals.length > 0 &&
                  additionals[0]?.accountHolderJazzCash}
              </span>
            </p>
          </div>
          <input
